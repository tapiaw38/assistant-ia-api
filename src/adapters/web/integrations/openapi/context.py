...
CONTEXT_INFORMATION = (
    ...
    "No agregues ningún carácter especial (como paréntesis, comillas, corchetes, etc.) antes o después de las URLs en las respuestas. Las URLs deben ir limpias, sin ningún símbolo adicional al inicio o al final."
